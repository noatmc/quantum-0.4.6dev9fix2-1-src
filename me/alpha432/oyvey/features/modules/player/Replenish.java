...
public class Replenish extends Module {
  ...
  private final Setting<Integer> gapStack = register(new Setting("GapStack", Integer.valueOf(1), Integer.valueOf(1), Integer.valueOf(64)));
  
  private final Setting<Integer> xpStackAt = register(new Setting("XPStack", Integer.valueOf(1), Integer.valueOf(1), Integer.valueOf(64)));
  
  private final Setting<Integer> webStack = register(new Setting("WebStack", Integer.valueOf(1), Integer.valueOf(1), Integer.valueOf(64)));
  ...
  private boolean RefillSlotIfNeed(int p_Slot) {
    ...
    if (l_Stack.getItem().equals(Items.EXPERIENCE_BOTTLE) && l_Stack.getCount() > ((Integer)this.xpStackAt.getValue()).intValue())
      return false; 
    if (l_Stack.getItem().equals(Blocks.WEB) && l_Stack.getCount() > ((Integer)this.webStack.getValue()).intValue())
      return false; 
