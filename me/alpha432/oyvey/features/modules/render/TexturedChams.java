...
public class TexturedChams extends Module {
  ...
  public TexturedChams() {
    ...
    rainbow = register(new Setting("Rainbow", Boolean.valueOf(false)));
    rainbowhue = register(new Setting("Brightness", Integer.valueOf(150), Integer.valueOf(0), Integer.valueOf(255)));
  }
}
