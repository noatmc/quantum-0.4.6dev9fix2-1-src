...
public class HoleESP extends Module {
  ...
  private final Setting<Integer> range = register(new Setting("RangeX", Integer.valueOf(5), Integer.valueOf(0), Integer.valueOf(20)));
  
  private final Setting<Integer> rangeY = register(new Setting("RangeY", Integer.valueOf(5), Integer.valueOf(0), Integer.valueOf(20)));
  
  public Setting<Boolean> newGradient = register(new Setting("NewGradient", Boolean.valueOf(false)));
