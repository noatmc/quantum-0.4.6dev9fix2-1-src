...
public class Offhand extends Module {
  ...
  public Setting<Float> gappleHealth = register(new Setting("GapHP", Float.valueOf(13.0F), Float.valueOf(0.1F), Float.valueOf(36.0F)));
  
  public Setting<Float> gappleHoleHealth = register(new Setting("GapHoleHP", Float.valueOf(3.5F), Float.valueOf(0.1F), Float.valueOf(36.0F)));
  
  public Setting<Bind> offHandCrystal = register(new Setting("Crystal", new Bind(-1)));
  
  public Setting<Float> crystalHealth = register(new Setting("CryHP", Float.valueOf(13.0F), Float.valueOf(0.1F), Float.valueOf(36.0F)));
  
  public Setting<Float> crystalHoleHealth = register(new Setting("CryHoleHP", Float.valueOf(3.5F), Float.valueOf(0.1F), Float.valueOf(36.0F)));
  
  public Setting<Float> cTargetDistance = register(new Setting("CryDistance", Float.valueOf(10.0F), Float.valueOf(1.0F), Float.valueOf(20.0F)));
  
  public Setting<Bind> obsidian = register(new Setting("Obsidian", new Bind(-1)));
  
  public Setting<Float> obsidianHealth = register(new Setting("ObbyHP", Float.valueOf(13.0F), Float.valueOf(0.1F), Float.valueOf(36.0F)));
  
  public Setting<Float> obsidianHoleHealth = register(new Setting("ObbyHoleHP", Float.valueOf(8.0F), Float.valueOf(0.1F), Float.valueOf(36.0F)));
  
  public Setting<Bind> webBind = register(new Setting("Webs", new Bind(-1)));
  
  public Setting<Float> webHealth = register(new Setting("WebHP", Float.valueOf(13.0F), Float.valueOf(0.1F), Float.valueOf(36.0F)));
  
  public Setting<Float> webHoleHealth = register(new Setting("WebHoleHP", Float.valueOf(8.0F), Float.valueOf(0.1F), Float.valueOf(36.0F)));
  
  public Setting<Boolean> holeCheck = register(new Setting("HoleCheck", Boolean.valueOf(true)));
  
  public Setting<Boolean> crystalCheck = register(new Setting("CrystalCheck", Boolean.valueOf(false)));
  
  public Setting<Boolean> gapSwap = register(new Setting("GapSwap", Boolean.valueOf(true)));
  ...
  public Setting<Boolean> crystalToTotem = register(new Setting("CrystalTotem", Boolean.valueOf(true), v -> (this.type.getValue() == Type.OLD)));
  ...
  public Setting<Integer> serverTimeOut = register(new Setting("ServerTimeout", Integer.valueOf(1000), Integer.valueOf(0), Integer.valueOf(5000)));
  ...
  private boolean noNearbyPlayers() {
    return (this.mode == Mode.CRYSTALS && mc.world.playerEntities.stream().noneMatch(e -> (e != mc.player && !OyVey.friendManager.isFriend(e) && mc.player.getDistance((Entity)e) <= ((Float)this.cTargetDistance.getValue()).floatValue())));
  }
