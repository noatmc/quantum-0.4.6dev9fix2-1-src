...
public class Selftrap extends Module {
  private final Setting<Integer> blocksPerTick = register(new Setting("BlocksPerTick", Integer.valueOf(20), Integer.valueOf(1), Integer.valueOf(20)));
  ...
  private final Setting<Integer> disableTime = register(new Setting("DisableTime", Integer.valueOf(200), Integer.valueOf(50), Integer.valueOf(300), v -> ((Boolean)this.disable.getValue()).booleanValue()));
