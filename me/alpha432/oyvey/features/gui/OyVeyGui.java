...
public class OyVeyGui extends GuiScreen {
  ...
  public void initGui() {
    if (OpenGlHelper.shadersSupported && this.mc.getRenderViewEntity() instanceof net.minecraft.entity.player.EntityPlayer && (ClickGui.getInstance()).mode.getValue() == ClickGui.Mode.BLUR) {
      if (this.mc.entityRenderer.getShaderGroup() != null)
        this.mc.entityRenderer.getShaderGroup().deleteShaderGroup(); 
