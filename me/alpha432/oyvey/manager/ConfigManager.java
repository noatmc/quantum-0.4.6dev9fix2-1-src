...
public class ConfigManager implements Util {
  ...
  public void loadConfig(String name) {
    List<File> files = (List<File>)Arrays.<Object>stream((Object[])Objects.requireNonNull((new File("Quantum")).listFiles())).filter(File::isDirectory).collect(Collectors.toList());
